...
argument_list|()
decl_stmt|;
comment|/**      * Run reports on a set of metadata.      *      * @param reportGroup the report set to run      * @param metadata    the RepositoryMetadata objects to report on      * @param repository  the repository that they come from      * @throws org.apache.maven.archiva.reporting.store.ReportingStoreException if there is a problem reading/writing the report database      */
specifier|public
name|void
