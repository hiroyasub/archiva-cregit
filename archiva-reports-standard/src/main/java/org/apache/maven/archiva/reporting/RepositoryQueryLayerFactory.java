...
begin_comment
comment|/**  * Gets the preferred implementation of a repository query layer for the given repository.  *  * @author<a href="mailto:brett@apache.org">Brett Porter</a>  * @version $Id$  */
end_comment
