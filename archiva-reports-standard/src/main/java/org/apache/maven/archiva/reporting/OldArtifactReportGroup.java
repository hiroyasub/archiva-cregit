...
begin_comment
comment|/**  * The report set for finding old artifacts (both snapshot and release)  *  * @plexus.component role="org.apache.maven.archiva.reporting.ReportGroup" role-hint="old-artifact"  */
end_comment
