...
begin_comment
comment|/**  * Constraint for snapshot artifacts that are of a certain age (in days) or older.   *  * @version $Id$  */
end_comment
...
name|whereClause
operator|=
literal|"this.lastModified<= cutoffDate&& this.snapshot == true"
expr_stmt|;
name|declImports
operator|=
operator|new
