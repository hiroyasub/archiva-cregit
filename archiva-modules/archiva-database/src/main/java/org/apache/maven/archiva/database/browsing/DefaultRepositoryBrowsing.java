...
argument_list|)
decl_stmt|;
comment|// it's possible that similar artifacts reside in different repos
if|if
condition|(
operator|!
name|artifacts
...
name|warn
argument_list|(
literal|"ArchivaDatabaseException occurred while querying for artifact '"
operator|+
name|groupId
operator|+
literal|":"
...
block|}
block|}
comment|// throw exception if pom artifact is still null!
if|if
condition|(
name|pomArtifact
operator|==
