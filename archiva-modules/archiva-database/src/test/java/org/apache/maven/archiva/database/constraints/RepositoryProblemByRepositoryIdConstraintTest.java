...
begin_comment
comment|/**  * RepositoryProblemByRepositoryIdConstraintTest  */
end_comment

begin_class
specifier|public
class|class
name|RepositoryProblemByRepositoryIdConstraintTest
extends|extends
name|AbstractArchivaDatabaseTestCase
block|{
specifier|private
...
name|assertNotNull
argument_list|(
literal|"Repository Problems by Repository Id: Not Null"
argument_list|,
name|results
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"Repository Problems by Repository Id: Results.size"
argument_list|,
name|expectedHits
argument_list|,
name|results
