...
begin_comment
comment|/**  * ArtifactsByRepositoryConstraintTest  *   * @version  */
end_comment
...
specifier|public
name|void
name|testQueryArtifactsInRepoByType
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertConstraint
argument_list|(
literal|"Artifacts of Type 'jar' By Repository and When Gathered"
argument_list|,
literal|3
argument_list|,
operator|new
...
name|assertConstraint
argument_list|(
literal|"Artifacts of Type 'war' By Repository and When Gathered"
argument_list|,
literal|2
argument_list|,
operator|new
