...
condition|)
block|{
comment|//TODO improvement in case of exact search and no classifier we must query for classifier with null value
comment|// currently it's done in DefaultSearchService with some filtering
block|}
name|BooleanQuery
name|qu
init|=
...
name|warn
argument_list|(
literal|"RepositorySearchException occured while accessing index of repository '{}' : {}"
argument_list|,
name|repo
argument_list|,
name|e
...
name|error
argument_list|(
literal|"Fatal situation: Maven repository without IndexingContext found."
argument_list|)
expr_stmt|;
continue|continue;
block|}
...
return|;
block|}
comment|/**      * return a managed repo for a remote result      *      * @param remoteRepo      * @param selectedRepos      * @return      */
specifier|private
name|String
name|getManagedRepoId
parameter_list|(
