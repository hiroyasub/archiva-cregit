...
begin_comment
comment|/**  * Maven implementation of index manager.  * The index manager is a singleton, so we try to make sure, that index operations are not running  * parallel by synchronizing on the index path.  * A update operation waits for parallel running methods to finish before starting, but after a certain  * time of retries a IndexUpdateFailedException is thrown.  */
end_comment
...
name|IllegalArgumentException
argument_list|(
literal|"The given repository does not support the indexcreation feature"
argument_list|)
throw|;
block|}
name|Path
...
name|error
argument_list|(
literal|"Could not create temporary directory for merged index: {}"
argument_list|,
name|e
operator|.
name|getMessage
...
name|IndexCreationFailedException
argument_list|(
literal|"IO error while creating temporary directory for merged index: "
operator|+
name|e
operator|.
name|getMessage
...
name|IllegalArgumentException
argument_list|(
literal|"The given repository does not have a local index path"
argument_list|)
throw|;
block|}
name|StorageAsset
...
name|IndexCreationFailedException
argument_list|(
literal|"IO Error during index merge: "
operator|+
name|e
operator|.
name|getMessage
...
name|IOException
argument_list|(
literal|"The given storage is not file based."
argument_list|)
throw|;
block|}
block|}
...
name|error
argument_list|(
literal|"Could not create index for asset {}"
argument_list|,
name|indexDirectory
argument_list|)
expr_stmt|;
