...
name|PlexusSisuBridgeException
block|{
comment|// TODO: Should be configurable!
name|this
operator|.
name|digesters
operator|=
...
argument_list|)
decl_stmt|;
comment|// We ignore the check, if the checksum file does not exist
if|if
condition|(
operator|!
name|Files
...
specifier|public
name|ArtifactHandlerManager
name|getArtifactHandlerManager
parameter_list|()
block|{
return|return
name|artifactHandlerManager
...
specifier|public
name|void
name|setArtifactHandlerManager
parameter_list|(
name|ArtifactHandlerManager
name|artifactHandlerManager
parameter_list|)
