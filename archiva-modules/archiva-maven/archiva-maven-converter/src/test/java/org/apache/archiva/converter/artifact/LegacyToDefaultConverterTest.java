...
argument_list|()
expr_stmt|;
comment|// ArtifactRepositoryFactory factory = plexusSisuBridge.lookup( ArtifactRepositoryFactory.class );
name|ArtifactRepositoryLayout
name|layout
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|/*          The POM isn't needed for Maven 1.x plugins but the raw conversion for             artifact = createPomArtifact( artifact );          Path pomFile = Paths.get( targetRepository.getBasedir(), targetRepository.pathOf( artifact ) );          File expectedPomFile = getTestFile( "src/test/expected-files/maven-foo-plugin-1.0.pom" );          assertTrue( "Check POM created", Files.exists(pomFile) );          compareFiles( expectedPomFile, pomFile );          */
block|}
annotation|@
name|Test
specifier|public
...
name|getBean
argument_list|(
literal|"artifactConverter#force-repository-converter"
argument_list|,
name|ArtifactConverter
operator|.
name|class
...
name|getBean
argument_list|(
literal|"artifactConverter#dryrun-repository-converter"
argument_list|,
name|ArtifactConverter
operator|.
name|class
...
condition|)
block|{
comment|/* No need to check any further */
return|return;
block|}
block|}
