...
begin_comment
comment|/**  * Provider for the maven2 repository implementation  */
end_comment
...
name|error
argument_list|(
literal|"Could not initialize filesystem for repository {}: '{}'"
argument_list|,
name|id
argument_list|,
name|e
