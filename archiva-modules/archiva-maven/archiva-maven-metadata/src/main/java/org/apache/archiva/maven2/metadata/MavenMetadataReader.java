...
name|IOException
argument_list|(
literal|"StorageAsset is not file based"
argument_list|)
throw|;
block|}
block|}
comment|/**      * Read and return the {@link org.apache.archiva.model.ArchivaRepositoryMetadata} object from the provided xml file.      *      * @param metadataFile the maven-metadata.xml file to read.      * @return the archiva repository metadata object that represents the provided file contents.      * @throws XMLException      */
specifier|public
specifier|static
name|ArchivaRepositoryMetadata
name|read
...
name|error
argument_list|(
literal|"Could not read file size of {}"
argument_list|,
name|metadataFile
argument_list|)
expr_stmt|;
