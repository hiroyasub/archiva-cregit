...
name|info
argument_list|(
literal|"Time to initalize DefaultRepositoryArchivaTaskScheduler: {} ms"
argument_list|,
name|stopWatch
operator|.
name|getTime
...
name|debug
argument_list|(
literal|"isPreviouslyScanned repo {} {} time: {} ms"
argument_list|,
name|repoConfig
operator|.
name|getId
...
name|warn
argument_list|(
literal|"Cron expression [{}] for repository [{}] is invalid.  Defaulting to hourly."
argument_list|,
name|cronString
argument_list|,
name|repoConfig
