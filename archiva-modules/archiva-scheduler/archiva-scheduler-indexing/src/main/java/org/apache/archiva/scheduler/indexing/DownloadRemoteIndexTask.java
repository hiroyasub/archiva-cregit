...
literal|0
decl_stmt|;
comment|//private long currentLength = 0;
specifier|private
name|ZeroCopyConsumerListener
parameter_list|(
name|File
...
name|info
argument_list|(
literal|"start transfer of {}, contentLength: {}"
argument_list|,
name|resourceName
argument_list|,
name|this
