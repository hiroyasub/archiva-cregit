...
begin_comment
comment|/**  *  * Service for uploading files to the repository.  *  * @author Olivier Lamy  * @author Martin Stockhammer  */
end_comment
...
expr_stmt|;
block|}
comment|// We always fix checksums for newly uploaded files, even if the content consumer is active.
name|boolean
name|fixChecksums
init|=
literal|true
decl_stmt|;
comment|// !(archivaAdministration.getKnownContentConsumers().contains("create-missing-checksums"));
try|try
block|{
name|StorageAsset
name|targetFile
