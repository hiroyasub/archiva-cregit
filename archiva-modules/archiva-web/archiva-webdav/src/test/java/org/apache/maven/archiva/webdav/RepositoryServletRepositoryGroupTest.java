...
operator|+
literal|"<versioning><latest>1.0</latest><release>1.0</release><versions><version>1.0</version>"
operator|+
literal|"<version>2.5</version><lastUpdated>20080708095554</lastUpdated></versioning></metadata>"
argument_list|,
literal|null
argument_list|)
expr_stmt|;
...
operator|+
literal|"<version>1.5</version><version>2.0</version><lastUpdated>20080709095554</lastUpdated>"
operator|+
...
literal|"<metadata><groupId>dummy</groupId><artifactId>dummy-merged-metadata-resource</artifactId>"
operator|+
literal|"<versioning><latest>2.5</latest><versions><version>1.0</version>"
operator|+
literal|"<version>1.5</version><version>2.0</version><version>2.5</version><lastUpdated>20080709095554</lastUpdated>"
operator|+
literal|"</versioning></metadata>"
decl_stmt|;
comment|//assertResponseOK( response );
comment|//assertEquals( "Expected file contents", expectedString, response.getText() );
block|}
specifier|protected
name|void
name|assertResponseMethodNotAllowed
