...
block|,
literal|"classpath*:/spring-context-servlet-security-test.xml"
block|}
argument_list|)
specifier|public
class|class
...
argument_list|()
decl_stmt|;
comment|// clear managed repository
name|List
argument_list|<
name|ManagedRepositoryConfiguration
argument_list|>
...
return|;
block|}
comment|/*protected void saveConfiguration()         throws Exception     {         saveConfiguration( archivaConfiguration );     }*/
specifier|protected
name|void
name|saveConfiguration
parameter_list|(
...
expr_stmt|;
block|}
comment|/*protected void setupCleanRepo( File repoRootDir )         throws IOException     {     }*/
annotation|@
name|Override
annotation|@
name|After
...
name|Exception
block|{
comment|/* if ( repoRootInternal.exists() )         {             FileUtils.deleteDirectory( repoRootInternal );         }*/
name|super
operator|.
name|tearDown
argument_list|()
...
name|setRequestURI
argument_list|(
literal|"/repository/internal/path/to/artifact.jar"
argument_list|)
expr_stmt|;
name|mockHttpServletRequest
operator|.
