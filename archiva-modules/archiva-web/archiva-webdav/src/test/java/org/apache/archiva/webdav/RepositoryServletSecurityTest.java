...
argument_list|)
expr_stmt|;
comment|// FIXME use mock to avoid starting Tomcat
comment|//RepositoryServlet repositoryServlet = new RepositoryServlet();
comment|//MockServletConfig mockServletConfig = new MockServletConfig();
comment|//MockServletContext mockServletContext = new MockServletContext(  );
comment|//mockServletContext
comment|//repositoryServlet.init( mockServletConfig );
name|servlet
operator|=
name|RepositoryServlet
operator|.
