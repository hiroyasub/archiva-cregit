...
specifier|private
name|String
name|defaultMergedMetadataLocation
init|=
literal|"${appserver.base}/data/maven-metadata.xml"
decl_stmt|;
specifier|public
name|DavResource
name|createResource
...
comment|// put the current session in the session map which will be passed to ArchivaXworkUser
name|Map
argument_list|<
name|String
argument_list|,
...
specifier|public
name|String
name|getDefaultMergedMetadataLocation
parameter_list|()
block|{
return|return
name|defaultMergedMetadataLocation
...
specifier|public
name|void
name|setDefaultMergedMetadataLocation
parameter_list|(
name|String
name|defaultMergedMetadataLocation
parameter_list|)
