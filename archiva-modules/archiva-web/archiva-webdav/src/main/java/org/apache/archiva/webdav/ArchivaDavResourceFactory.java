...
name|debug
argument_list|(
literal|"RepositoryException remote repository with d'{}' not found, msg: {}"
argument_list|,
name|archivaLocator
operator|.
name|getRepositoryId
...
comment|// so use the first one
comment|// FIXME add a method with group in the repository storage
name|String
name|firstRepoId
init|=
name|repositoryGroupConfiguration
