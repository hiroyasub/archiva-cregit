...
name|resolve
argument_list|(
literal|"data/repositories/test-origin-repo/org/apache/karaf/features/org.apache.karaf.features.core/2.2.2/org.apache.karaf.features.core-2.2.2.jar"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|resolve
argument_list|(
literal|"data/repositories/test-origin-repo/commons-logging/commons-logging/1.0.1/commons-logging-1.0.1-javadoc.jar"
argument_list|)
decl_stmt|;
name|Path
...
name|resolve
argument_list|(
literal|"data/repositories/test-origin-repo/commons-logging/commons-logging/1.0.1/commons-logging-1.0.1-javadoc.jar.md5"
argument_list|)
decl_stmt|;
name|Path
...
name|resolve
argument_list|(
literal|"data/repositories/test-origin-repo/commons-logging/commons-logging/1.0.1/commons-logging-1.0.1-javadoc.jar.sha1"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|resolve
argument_list|(
literal|"data/repositories/test-origin-repo/org/apache/karaf/features/org.apache.karaf.features.command"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|resolve
argument_list|(
literal|"data/repositories/repo-with-snapshots"
argument_list|)
decl_stmt|;
if|if
condition|(
