...
expr_stmt|;
block|}
comment|//File targetRepo = new File( "target/test-origin-repo" );
comment|//if ( targetRepo.exists() )
comment|//{
comment|//    FileUtils.deleteDirectory( targetRepo );
comment|//}
comment|//assertFalse( targetRepo.exists() );
comment|//FileUtils.copyDirectory( new File( "src/test/repo-with-osgi" ), targetRepo );
name|ManagedRepository
name|managedRepository
init|=
operator|new
