...
name|String
argument_list|>
name|remoteConnectivityCheckPaths
init|=
operator|new
name|HashMap
argument_list|<>
...
parameter_list|()
block|{
comment|// default initialization for known servers
name|remoteConnectivityCheckPaths
operator|.
name|put
argument_list|(
...
argument_list|,
literal|"com/sleepycat/je/license.txt"
argument_list|)
expr_stmt|;
name|remoteConnectivityCheckPaths
operator|.
name|put
argument_list|(
literal|"https://download.oracle.com/maven"
argument_list|,
literal|"com/sleepycat/je/license.txt"
argument_list|)
expr_stmt|;
...
name|String
argument_list|>
name|getRemoteConnectivityCheckPaths
parameter_list|()
block|{
return|return
name|remoteConnectivityCheckPaths
...
specifier|public
name|void
name|setRemoteConnectivityCheckPaths
parameter_list|(
name|Map
argument_list|<
name|String
