...
name|RepositoryException
argument_list|(
literal|"Could not find repository "
operator|+
name|id
argument_list|)
throw|;
...
name|ArchivaRestServiceException
argument_list|(
literal|"repositories.read.managable.error"
argument_list|,
name|Response
operator|.
name|Status
...
name|error
argument_list|(
literal|"No repository content found for "
operator|+
name|repoId
argument_list|)
expr_stmt|;
