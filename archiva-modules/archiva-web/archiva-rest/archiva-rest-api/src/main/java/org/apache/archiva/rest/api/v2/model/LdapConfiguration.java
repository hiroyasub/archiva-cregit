...
name|String
argument_list|>
name|availableContextFactories
decl_stmt|;
specifier|public
name|LdapConfiguration
parameter_list|( )
...
name|name
operator|=
literal|"context_factory"
argument_list|,
name|description
operator|=
literal|"The class name of the LDAP context factory"
argument_list|)
specifier|public
name|String
name|getContextFactory
...
name|description
operator|=
literal|"True, if SSL/TLS should be used for connecting the LDAP server"
argument_list|)
specifier|public
name|boolean
name|isSslEnabled
...
name|description
operator|=
literal|"LDAP ConnectionFactory environment properties"
argument_list|)
specifier|public
name|Map
argument_list|<
...
name|name
operator|=
literal|"available_context_factories"
argument_list|,
name|description
operator|=
literal|"The LDAP context factories that are known and available"
argument_list|)
specifier|public
name|List
argument_list|<
name|String
argument_list|>
name|getAvailableContextFactories
parameter_list|( )
block|{
return|return
name|availableContextFactories
...
specifier|public
name|void
name|addAvailableContextFactory
parameter_list|(
name|String
name|contextFactory
parameter_list|)
