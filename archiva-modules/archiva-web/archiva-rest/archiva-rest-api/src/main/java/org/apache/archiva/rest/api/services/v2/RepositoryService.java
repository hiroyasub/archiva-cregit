...
name|summary
operator|=
literal|"Removes a scan task from the queue."
argument_list|,
name|security
operator|=
block|{
...
name|Path
argument_list|(
literal|"managed/{id}/artifact/copy"
argument_list|)
annotation|@
name|POST
annotation|@
...
name|summary
operator|=
literal|"Copies a artifact between repositories."
argument_list|,
name|security
operator|=
block|{
...
name|Path
argument_list|(
literal|"managed/{id}/index/download/start"
argument_list|)
annotation|@
name|POST
annotation|@
