...
name|ArchivaRestServiceException
function_decl|;
comment|/**      * Returns the scan status of the given repository      * @param repositoryId the repository identifier      * @return the status      * @throws ArchivaRestServiceException      * @since 3.0      */
annotation|@
name|Path
argument_list|(
...
name|Path
argument_list|(
literal|"projectVersion/{repositoryId}/{namespace}/{projectId}/{version}"
argument_list|)
annotation|@
name|DELETE
annotation|@
...
name|ArchivaRestServiceException
function_decl|;
comment|/**      * Returns the permission status for the current user and the given repository.      * @param repoId the repository identifier      * @return the status      * @throws ArchivaRestServiceException      * @since 3.0      */
annotation|@
name|Path
argument_list|(
literal|"isAuthorizedToDeleteArtifacts/{repositoryId}"
argument_list|)
annotation|@
name|GET
annotation|@
...
name|Path
argument_list|(
literal|"project/{repositoryId}/{groupId}/{projectId}"
argument_list|)
annotation|@
name|DELETE
annotation|@
...
name|Path
argument_list|(
literal|"runningRemoteDownloadIds"
argument_list|)
annotation|@
name|GET
annotation|@
