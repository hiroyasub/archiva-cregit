...
name|executeScript
argument_list|(
literal|"arguments[0].scrollIntoView();"
argument_list|,
name|el
argument_list|)
expr_stmt|;
...
name|id
argument_list|(
literal|"remote-repository-edit-fieldset"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
comment|// Another hack, don't know why the normal selectValue() does not work here
operator|(
operator|(
name|JavascriptExecutor
operator|)
...
name|executeScript
argument_list|(
literal|"jQuery('#sourceRepoId').css('display','block')"
argument_list|)
expr_stmt|;
name|Select
name|select
...
name|xpath
argument_list|(
literal|".//select[@id='sourceRepoId']"
argument_list|)
argument_list|)
argument_list|)
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// selectValue( "sourceRepoId", "internal", true );
comment|// Workaround
...
name|ExpectedConditions
operator|.
name|numberOfElementsToBe
argument_list|(
name|By
operator|.
name|xpath
argument_list|(
literal|"//div[@id='proxy-connector-edit-order-div']/div"
argument_list|)
argument_list|,
literal|2
argument_list|)
