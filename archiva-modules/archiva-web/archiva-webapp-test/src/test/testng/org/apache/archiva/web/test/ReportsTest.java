...
specifier|public
name|void
name|testRepositoriesStatisticComparisonReport
parameter_list|()
block|{
name|goToReportsPage
argument_list|()
...
specifier|public
name|void
name|testRepositoryHealthWithoutGroupId
parameter_list|()
block|{
name|goToReportsPage
argument_list|()
...
argument_list|)
expr_stmt|;
comment|//TODO As of the creation of the tests, GroupId is not a required field in showing the reports of repository health. GroupId should be required I think.
block|}
block|}
end_class
