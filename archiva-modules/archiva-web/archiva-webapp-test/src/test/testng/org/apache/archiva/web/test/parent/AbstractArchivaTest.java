...
parameter_list|()
block|{
comment|//assertPage( "Apache Archiva \\ Upload Artifact" );
name|String
name|uploadArtifact
init|=
...
name|uploadElements
init|=
literal|"groupId,artifactId,version,packaging,classifier,generatePom,artifact,pom,repositoryId"
decl_stmt|;
name|String
index|[]
name|arrayUploadElements
init|=
name|uploadElements
operator|.
name|split
