...
argument_list|)
expr_stmt|;
name|assertMinimalMetadataDisplay
argument_list|()
expr_stmt|;
block|}
specifier|public
name|void
name|testDeleteMetadataDependency
parameter_list|()
block|{
name|String
name|depArtifactId
...
name|xPath
init|=
literal|"//li[contains(text(),'"
operator|+
name|depArtifactId
operator|+
literal|"')]/a/img[contains(@src,'delete.gif')]"
decl_stmt|;
...
specifier|public
name|void
name|testDeleteMetadataMailingList
parameter_list|()
block|{
name|String
name|listName
init|=
literal|"test user list"
decl_stmt|;
name|goToBrowsePage
argument_list|()
expr_stmt|;
...
specifier|public
name|void
name|testDeleteMetadataLicense
parameter_list|()
block|{
name|String
name|licenseName
init|=
literal|"Test License"
decl_stmt|;
name|goToBrowsePage
argument_list|()
expr_stmt|;
