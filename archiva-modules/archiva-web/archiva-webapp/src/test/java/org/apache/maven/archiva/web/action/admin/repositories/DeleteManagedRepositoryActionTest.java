...
name|RepositoryAdminException
block|{
comment|//Configuration originalConfiguration =
comment|//    ( (DefaultManagedRepositoryAdmin) getManagedRepositoryAdmin() ).getArchivaConfiguration().getConfiguration();
name|location
operator|.
name|mkdirs
argument_list|()
