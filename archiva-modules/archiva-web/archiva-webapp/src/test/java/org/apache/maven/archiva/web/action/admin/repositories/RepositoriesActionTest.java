...
argument_list|()
expr_stmt|;
comment|// some other test are modifying archivaConfiguration with a mocked instance : this test need the real one
comment|// so use the real one from spring, backup the mock and restore it at the end (tearDown)
name|ArchivaConfiguration
name|real
init|=
