...
name|newInvocation
argument_list|(
literal|"http://localhost/rss/rss_feeds"
argument_list|)
operator|.
name|getServlet
argument_list|()
...
argument_list|)
expr_stmt|;
comment|//WebResponse response = client.getResponse( "http://localhost/rss/rss_feeds" );
comment|//assertNotNull( "Should have recieved a response", response );
comment|//assertEquals( "Should have been a bad request response code.", HttpServletResponse.SC_BAD_REQUEST, response.getResponseCode() );
block|}
annotation|@
name|Override
specifier|protected
