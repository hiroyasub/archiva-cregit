...
argument_list|)
expr_stmt|;
comment|//consumers.executeConsumers( repoConfig, repository.toFile( artifactReference ) );
block|}
catch|catch
parameter_list|(
name|IOException
...
argument_list|)
expr_stmt|;
comment|//consumers.executeConsumers( repoConfig, generatedPomFile );
block|}
catch|catch
parameter_list|(
name|IOException
...
argument_list|)
expr_stmt|;
comment|//consumers.executeConsumers( repoConfig, new File( targetPath, pomFilename ) );
block|}
catch|catch
parameter_list|(
name|IOException
