...
condition|)
block|{
comment|// [MRM-789] Archiva may delete your app server installation
name|Properties
name|props
init|=
name|System
...
name|addActionError
argument_list|(
literal|"Unable to delete repository. The location is being referenced in the system properties."
argument_list|)
expr_stmt|;
return|return
name|ERROR
