...
argument_list|)
expr_stmt|;
comment|// securitySystem =
comment|// (SecuritySystem) wac.getBean( PlexusToSpringUtils.buildSpringId( SecuritySystem.class.getName() ) );
name|userRepositories
operator|=
operator|(
name|UserRepositories
...
expr_stmt|;
comment|// httpAuth =
comment|// (HttpAuthenticator) wac.getBean( PlexusToSpringUtils.buildSpringId( HttpAuthenticator.ROLE, "basic" ) );
name|servletAuth
operator|=
operator|(
name|ServletAuthenticator
