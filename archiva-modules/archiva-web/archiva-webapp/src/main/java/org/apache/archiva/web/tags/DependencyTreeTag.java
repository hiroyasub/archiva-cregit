...
name|tldTagClass
operator|=
literal|"org.apache.archiva.web.tags.DependencyTreeTag"
argument_list|,
name|description
operator|=
literal|"Render a dependency tree for the provided project."
argument_list|)
specifier|public
class|class
...
name|description
operator|=
literal|"The variable name for the node."
argument_list|,
name|type
operator|=
literal|"String"
...
name|description
operator|=
literal|"The version of the project model. Used to verify the dependency graph for generic snapshots not yet in the repo."
argument_list|,
name|type
operator|=
literal|"String"
