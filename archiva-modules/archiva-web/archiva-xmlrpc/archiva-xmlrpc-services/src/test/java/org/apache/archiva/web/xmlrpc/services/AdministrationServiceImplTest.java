...
name|Exception
block|{
comment|//archivaConfigControl.reset();
comment|//archivaConfigControl.expectAndReturn( archivaConfig.getConfiguration(), config, 1 );
comment|//configControl.expectAndReturn( config.getManagedRepositories(), new ArrayList( 0 ), 1 );
comment|//managedRepositoryAdmin.shutdown();
block|}
...
name|fail
argument_list|(
literal|"An exception should have been thrown! Repository ID is not valid."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"An exception should have been thrown! Repository name is not valid."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|name
argument_list|,
literal|"${appserver.base}/<script>alert('xss')</script>"
operator|+
name|projId
operator|+
literal|".releases"
...
name|fail
argument_list|(
literal|"An exception should have been thrown! Repository location is not valid."
argument_list|)
expr_stmt|;
block|}
catch|catch
