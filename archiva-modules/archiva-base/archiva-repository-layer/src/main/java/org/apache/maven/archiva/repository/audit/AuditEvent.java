...
parameter_list|()
block|{
comment|// we add the resource name to the end to avoid clashes at that timestamp
comment|// TODO: this is still not robust enough and the content model should be revised
return|return
name|createNameFormat
argument_list|()
operator|.
