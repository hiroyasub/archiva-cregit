...
decl_stmt|;
comment|/**      * @plexus.requirement role-hint="new-artifacts"      */
specifier|private
name|RssFeedProcessor
name|rssFeedProcessor
decl_stmt|;
...
argument_list|()
decl_stmt|;
comment|// TODO: filter the file types of artifacts that will be included in the rss feeds
try|try
block|{
name|ManagedRepositoryContent
name|repository
