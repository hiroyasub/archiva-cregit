...
begin_comment
comment|// import org.apache.archiva.maven2.metadata.MavenMetadataReader;
end_comment
...
name|error
argument_list|(
literal|"Error while accessing repository: {}"
argument_list|,
name|e
operator|.
name|getMessage
...
name|error
argument_list|(
literal|"Trying to read metadata from container: {}"
argument_list|,
name|asset
operator|.
name|getPath
...
name|error
argument_list|(
literal|"Could not read metadata file {}"
argument_list|,
name|asset
argument_list|,
name|e
