...
block|,
literal|"classpath:/spring-context-managed.xml"
block|}
argument_list|)
class|class
name|ManagedRepositoryHandlerTest
block|{
static|static
block|{
name|initialize
...
name|resolve
argument_list|(
literal|"src/test/resources/archiva-managed.xml"
argument_list|)
decl_stmt|;
if|if
condition|(
...
name|resolve
argument_list|(
literal|"target/test-classes/archiva-managed.xml"
argument_list|)
decl_stmt|;
try|try
block|{
