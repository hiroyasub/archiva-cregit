...
block|}
block|}
comment|/*      * Test before and after the properties are evaluated. pom snippet:<maven.version>2.0.5</maven.version>      *<wagon.version>1.0-beta-2</wagon.version><plexus-security.version>1.0-alpha-10-SNAPSHOT</plexus-security.version>      */
specifier|public
name|void
name|testEffectiveProjectProperty
parameter_list|()
throws|throws
name|Exception
block|{
...
name|pomFile
init|=
literal|"/org/apache/maven/archiva/archiva/1.0-SNAPSHOT/archiva-1.0-SNAPSHOT.pom"
decl_stmt|;
name|ArchivaProjectModel
name|startModel
init|=
...
decl_stmt|;
name|String
name|plexusSecurityVersion
init|=
literal|"1.0-alpha-10-SNAPSHOT"
decl_stmt|;
name|String
name|wagonVersion
init|=
...
decl_stmt|;
name|boolean
name|passedPlexusVersionChecking
init|=
literal|false
decl_stmt|;
name|boolean
name|passedWagonVersionChecking
init|=
literal|false
decl_stmt|;
name|List
...
if|if
condition|(
literal|"org.codehaus.plexus.security"
operator|.
name|equals
argument_list|(
name|startDep
...
argument_list|()
argument_list|,
literal|"${plexus-security.version}"
argument_list|)
expr_stmt|;
block|}
if|else if
...
specifier|public
name|void
name|testEffectiveProjectPropertyExistingParentHasUniqueSnapshotVersion
parameter_list|()
throws|throws
name|Exception
block|{
...
name|pomFile
init|=
literal|"/org/apache/archiva/sample-project/2.1-SNAPSHOT/sample-project-2.1-SNAPSHOT.pom"
decl_stmt|;
name|ArchivaProjectModel
name|startModel
init|=
...
decl_stmt|;
name|String
name|buildHelperPluginVersion
init|=
literal|"1.0"
decl_stmt|;
name|boolean
name|passedBuildHelperVersionChecking
init|=
literal|false
decl_stmt|;
name|List
...
if|if
condition|(
literal|"build-helper-maven-plugin"
operator|.
name|equals
argument_list|(
name|plugin
...
name|assertEquals
argument_list|(
literal|"${build-helper-maven-plugin.version}"
argument_list|,
name|plugin
operator|.
name|getVersion
