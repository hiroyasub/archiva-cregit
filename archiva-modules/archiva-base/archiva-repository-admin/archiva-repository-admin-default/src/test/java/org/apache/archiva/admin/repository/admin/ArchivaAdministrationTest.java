...
name|assertEquals
argument_list|(
literal|"File type [artifacts] already contains pattern [**/*.jar]"
argument_list|,
name|e
operator|.
name|getMessage
...
block|{
name|OrganisationInformation
name|oldOrganisationInformation
init|=
name|archivaAdministration
operator|.
...
argument_list|)
expr_stmt|;
comment|// back to initial OrganisationInformation //MRM-1638
name|archivaAdministration
operator|.
name|setOrganisationInformation
argument_list|(
...
specifier|public
name|void
name|badOrganisationInfoLogoLocation
parameter_list|( )
block|{
try|try
block|{
