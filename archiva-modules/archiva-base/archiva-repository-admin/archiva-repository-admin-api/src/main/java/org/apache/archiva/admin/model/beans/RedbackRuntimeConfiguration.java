...
literal|false
decl_stmt|;
comment|/**      * TimeToIdleSeconds for users cache.      */
specifier|private
name|int
name|useUsersCacheTimeToIdleSeconds
init|=
literal|14400
decl_stmt|;
comment|/**      * TimeToLiveSeconds for users cache.      */
specifier|private
name|int
name|useUsersCacheTimeToLiveSeconds
init|=
literal|14400
decl_stmt|;
specifier|public
...
specifier|public
name|void
name|setUseUsersCacheTimeToIdleSeconds
parameter_list|(
name|int
name|useUsersCacheTimeToIdleSeconds
parameter_list|)
...
specifier|public
name|void
name|setUseUsersCacheTimeToLiveSeconds
parameter_list|(
name|int
name|useUsersCacheTimeToLiveSeconds
parameter_list|)
...
name|append
argument_list|(
literal|", useUsersCacheTimeToIdleSeconds="
argument_list|)
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|", useUsersCacheTimeToLiveSeconds="
argument_list|)
operator|.
name|append
argument_list|(
