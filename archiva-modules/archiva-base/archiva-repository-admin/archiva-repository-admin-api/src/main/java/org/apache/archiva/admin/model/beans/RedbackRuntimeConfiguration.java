...
specifier|private
name|int
name|usersCacheTimeToIdleSeconds
init|=
literal|14400
decl_stmt|;
...
specifier|private
name|int
name|usersCacheTimeToLiveSeconds
init|=
literal|14400
decl_stmt|;
specifier|public
...
specifier|public
name|void
name|setUsersCacheTimeToIdleSeconds
parameter_list|(
name|int
name|usersCacheTimeToIdleSeconds
parameter_list|)
...
specifier|public
name|void
name|setUsersCacheTimeToLiveSeconds
parameter_list|(
name|int
name|usersCacheTimeToLiveSeconds
parameter_list|)
...
name|append
argument_list|(
literal|", usersCacheTimeToIdleSeconds="
argument_list|)
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|", usersCacheTimeToLiveSeconds="
argument_list|)
operator|.
name|append
argument_list|(
