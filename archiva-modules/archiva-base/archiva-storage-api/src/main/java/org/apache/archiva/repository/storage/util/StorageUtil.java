...
block|}
block|}
comment|/**      * Deletes the given asset and all child assets recursively.      * @param srcAsset The source directory      * @param destAsset The destination directory      * @param stopOnError if<code>true</code> the traversal stops, if an exception is encountered      * @return returns<code>true</code>, if every item was removed. If an IOException was encountered during      * traversal it returns<code>false</code>      */
specifier|public
specifier|static
specifier|final
name|boolean
