...
expr_stmt|;
block|}
comment|/**      * Saves the configuration and adds the given tag to the event.      * @param configuration the configuration to save      * @param eventTag the tag to add to the configuration saved event      * @throws IndeterminateConfigurationException if the      * @throws RegistryException      */
annotation|@
name|Override
specifier|public
specifier|synchronized
...
comment|// this.dataDirectory = null;
comment|// this.repositoryBaseDirectory = null;
block|}
specifier|private
name|String
