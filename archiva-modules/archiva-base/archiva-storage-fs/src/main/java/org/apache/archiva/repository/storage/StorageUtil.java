...
block|}
block|}
comment|/**      * Deletes the given asset and all child assets recursively.      * @param baseDir The base asset to remove.      * @throws IOException      */
specifier|public
specifier|static
specifier|final
name|void
