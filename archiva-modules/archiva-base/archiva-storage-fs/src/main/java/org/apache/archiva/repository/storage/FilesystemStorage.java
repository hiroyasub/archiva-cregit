...
return|;
block|}
comment|/**      * Updates the location and releases all locks.      *      * @param newLocation The URI to the new location      *      * @throws IOException If the directory cannot be created.      */
annotation|@
name|Override
specifier|public
name|void
...
name|IOException
argument_list|(
literal|"The origin asset does not belong to this storage instance. Cannot copy between different storage instances."
argument_list|)
throw|;
block|}
if|if
...
name|IOException
argument_list|(
literal|"The destination asset does not belong to this storage instance. Cannot copy between different storage instances."
argument_list|)
throw|;
block|}
name|Files
