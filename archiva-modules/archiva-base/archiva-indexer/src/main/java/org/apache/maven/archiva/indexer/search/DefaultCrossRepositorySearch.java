...
name|warn
argument_list|(
literal|"Unable to parse advanced search fields and query terms."
argument_list|)
expr_stmt|;
block|}
return|return
...
decl_stmt|;
name|DuplicateFilter
name|artifactIdDuplicateFilter
init|=
operator|new
name|DuplicateFilter
argument_list|(
...
block|{
comment|// AND the previous search terms
name|BooleanQuery
name|booleanQuery
init|=
operator|new
