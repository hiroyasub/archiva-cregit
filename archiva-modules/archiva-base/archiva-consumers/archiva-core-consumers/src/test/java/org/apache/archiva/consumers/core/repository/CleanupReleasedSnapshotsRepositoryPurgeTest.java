...
argument_list|)
expr_stmt|;
comment|// XMLAssert.assertXpathEvaluatesTo( "2.3", "//metadata/versioning/release", metadataXml );
name|XmlAssert
operator|.
name|assertThat
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// XMLAssert.assertXpathEvaluatesTo( "2.3", "//metadata/versioning/latest", metadataXml );
name|XmlAssert
operator|.
name|assertThat
argument_list|(
...
name|valueByXPath
argument_list|(
literal|"//metadata/versioning/versions/version[1]"
argument_list|)
operator|.
name|isEqualTo
argument_list|(
...
name|valueByXPath
argument_list|(
literal|"//metadata/versioning/versions/version[2]"
argument_list|)
operator|.
name|isEqualTo
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// XMLAssert.assertXpathsEqual( "//expected/versions/version", expectedVersions,
comment|//                             "//metadata/versioning/versions/version", metadataXml );
name|XmlAssert
operator|.
name|assertThat
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// XMLAssert.assertXpathEvaluatesTo( "20070315032817", "//metadata/versioning/lastUpdated", metadataXml );
block|}
annotation|@
name|Test
specifier|public
...
argument_list|)
expr_stmt|;
comment|// XMLAssert.assertXpathEvaluatesTo( "2.0.4-SNAPSHOT", "//metadata/versioning/latest", metadataXml );
name|XmlAssert
operator|.
name|assertThat
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// XMLAssert.assertXpathEvaluatesTo( "20070427033345", "//metadata/versioning/lastUpdated", metadataXml );
block|}
block|}
end_class
