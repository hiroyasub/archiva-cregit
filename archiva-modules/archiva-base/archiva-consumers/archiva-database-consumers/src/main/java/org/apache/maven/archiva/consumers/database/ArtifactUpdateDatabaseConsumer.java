...
begin_comment
comment|/**  * ArtifactUpdateDatabaseConsumer - Take an artifact off of disk and put it into the repository.  *  * @version $Id$  * @plexus.component role="org.apache.maven.archiva.consumers.KnownRepositoryContentConsumer"  *                   role-hint="update-db-artifact"  *                   instantiation-strategy="per-lookup"  */
end_comment
...
argument_list|)
expr_stmt|;
comment|// set this to when the artifact was first discovered in the repo
if|if
condition|(
name|artifact
operator|.
