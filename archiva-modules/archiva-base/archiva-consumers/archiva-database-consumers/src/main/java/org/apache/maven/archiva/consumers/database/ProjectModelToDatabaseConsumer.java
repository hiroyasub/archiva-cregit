...
name|info
argument_list|(
literal|"++++ [AfterRead] organization NAME --> "
operator|+
name|organization
operator|.
name|getName
...
name|info
argument_list|(
literal|"++++ [AfterRead] issueMgnt url --> "
operator|+
name|iM
operator|.
name|getUrl
...
name|info
argument_list|(
literal|"++++ [AfterFilter] organization NAME --> "
operator|+
name|organization
operator|.
name|getName
...
name|info
argument_list|(
literal|"++++ [AfterFilter] issueMgnt url --> "
operator|+
name|iM
operator|.
name|getUrl
...
name|info
argument_list|(
literal|"++++ [AfterClone] organization NAME --> "
operator|+
name|organization
operator|.
name|getName
...
name|info
argument_list|(
literal|"++++ [AfterClone] issueMgnt url --> "
operator|+
name|iM
operator|.
name|getUrl
