...
specifier|public
class|class
name|PropagateErrorsDownloadPolicyTest
extends|extends
name|TestCase
block|{
annotation|@
...
name|assertEquals
argument_list|(
literal|"Propagate Download Errors Policy"
argument_list|,
name|policy
operator|.
name|getName
...
name|contains
argument_list|(
literal|"error occurs during download"
argument_list|)
argument_list|)
expr_stmt|;
name|assertEquals
...
name|contains
argument_list|(
literal|"Stops the artifact download"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
