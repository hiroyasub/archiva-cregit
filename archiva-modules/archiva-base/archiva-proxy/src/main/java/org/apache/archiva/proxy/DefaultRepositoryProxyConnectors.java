...
return|;
block|}
comment|/**      * @param connector      * @param remoteRepository      * @param tmpMd5      * @param tmpSha1      * @param tmpResource      * @param url      * @param remotePath      * @param resource      * @param workingDirectory      * @param repository      * @throws ProxyException      * @throws NotModifiedException      * @throws org.apache.archiva.admin.model.RepositoryAdminException      */
specifier|protected
name|void
...
name|error
argument_list|(
literal|"Could get the modified time of file {}"
argument_list|,
name|file
operator|.
name|toAbsolutePath
...
name|ProxyException
argument_list|(
literal|"Unable to create parent directory "
operator|+
name|lock
operator|.
name|getFile
