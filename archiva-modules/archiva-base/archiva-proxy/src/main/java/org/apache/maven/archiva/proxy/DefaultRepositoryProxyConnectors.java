...
return|;
block|}
comment|// MRM-631 - the lightweight wagon does not reset these - remove if we switch to httpclient based wagon
name|String
name|previousHttpProxyHost
init|=
name|System
operator|.
name|getProperty
...
return|;
block|}
comment|/**      * Moves the file into repository location if it exists      *       * @param fileToMove this could be either the main artifact, sha1 or md5 checksum file.      * @param localFile this is always the main artifact      */
specifier|private
name|void
name|moveFileIfExists
parameter_list|(
