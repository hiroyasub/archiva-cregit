...
name|consumers
decl_stmt|;
comment|/**      * Fetch an artifact from a remote repository.      *      * @param repository the managed repository to utilize for the request.      * @param artifact   the artifact reference to fetch.      * @return the local file in the managed repository that was fetched, or null if the artifact was not (or      *         could not be) fetched.      * @throws PolicyViolationException if there was a problem fetching the artifact.      */
specifier|public
name|File
...
argument_list|)
expr_stmt|;
comment|// TODO: add into repository report?
block|}
catch|catch
parameter_list|(
name|RepositoryMetadataException
...
block|}
block|}
comment|/**      * Perform the transfer of the remote file to the local file specified.      *      * @param wagon the wagon instance to use.      * @param remoteRepository the remote repository to use      * @param remotePath the remote path to attempt to get      * @param repository the managed repository that will hold the transfered file      * @param localFile the local file to save to      * @return The local file that was transfered.      * @throws ProxyException if there was a problem moving the downloaded file into place.      * @throws WagonException if there was a problem tranfering the file.      */
specifier|private
name|File
name|transferSimpleFile
parameter_list|(
...
name|ProxyException
argument_list|(
literal|"Could not create temporary file at "
operator|+
name|localFile
operator|.
name|getAbsolutePath
...
name|debug
argument_list|(
literal|"No authentication for remote repository needed"
argument_list|)
expr_stmt|;
block|}
