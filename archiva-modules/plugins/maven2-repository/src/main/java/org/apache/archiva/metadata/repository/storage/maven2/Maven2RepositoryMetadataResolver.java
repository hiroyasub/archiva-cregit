...
return|;
block|}
comment|// if metadata is missing, scan directories for a valid project version subdirectory, meaning this must be a
...
return|;
block|}
comment|// if metadata is missing, check if there is a POM artifact file to ensure it is a version directory
name|File
index|[]
name|files
decl_stmt|;
