...
begin_comment
comment|/**  * @plexus.component role="org.apache.archiva.metadata.repository.storage.StorageMetadataResolver" role-hint="maven2"  */
end_comment
...
name|MetadataResolutionException
block|{
comment|// Remove problems associated with this version, since we'll be re-adding any that still exist
comment|// TODO: an event mechanism would remove coupling to the problem reporting plugin
comment|// TODO: this removes all problems - do we need something that just removes the problems created by this resolver?
name|String
name|name
init|=
name|RepositoryProblemFacet
...
name|warn
argument_list|(
literal|"Unable to remove repository problem facets for the version being removed: "
operator|+
name|e
operator|.
name|getMessage
...
parameter_list|)
block|{
comment|// TODO: useful, but not implemented yet, not called from DefaultMetadataResolver
throw|throw
operator|new
...
parameter_list|)
block|{
comment|// Can't be determined on a Maven 2 repository
throw|throw
operator|new
name|UnsupportedOperationException
argument_list|()
