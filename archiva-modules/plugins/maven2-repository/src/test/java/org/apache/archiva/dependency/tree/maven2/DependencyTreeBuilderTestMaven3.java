...
argument_list|)
decl_stmt|;
comment|//springContext.setPremanagedVersion( "2.5.5" );
name|nodes
operator|.
name|put
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//plexusUtils.setPremanagedVersion( "1.5.1" );
name|nodes
operator|.
name|put
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//slf4jLog4j12.setPremanagedScope( "test" );
name|nodes
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//plexusRegistryCommons.setPremanagedVersion( "1.0-alpha-3" );
name|DependencyNode
...
argument_list|)
expr_stmt|;
comment|//plexusRegistryApi.setPremanagedVersion( "1.0-alpha-3" );
name|DependencyNode
name|plexusSpring
init|=
operator|new
...
init|=
operator|new
name|TestDefaultDependencyNode
argument_list|(
operator|new
name|Dependency
argument_list|(
