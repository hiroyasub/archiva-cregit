...
specifier|public
class|class
name|Maven2RepositoryMetadataResolverMRM1411RepoGroupTest
extends|extends
name|TestCase
block|{
specifier|private
...
name|get
argument_list|(
literal|"target/test-repositorys"
argument_list|)
operator|.
name|toAbsolutePath
argument_list|()
...
argument_list|(
literal|"src/test/resources/com/example/test/test-artifact-module-a"
argument_list|,
...
name|copyTestArtifactWithParent
argument_list|(
literal|"src/test/resources/com/example/test/test-artifact-root"
argument_list|,
...
argument_list|,
literal|"target/test-repositorys/com/example/test/test-snapshot-artifact-module-a"
argument_list|)
expr_stmt|;
name|copyTestArtifactWithParent
argument_list|(
...
literal|"src/test/resources/com/example/test/test-artifact-parent"
argument_list|,
literal|"target/test-repositorys/com/example/test/test-artifact-parent"
argument_list|)
expr_stmt|;
name|ReadMetadataRequest
name|readMetadataRequest
...
specifier|public
name|void
name|testGetProjectVersionMetadataWithParentSnapshotVersionAndSnapNotAllowed2
parameter_list|()
throws|throws
name|Exception
block|{
name|copyTestArtifactWithParent
argument_list|(
literal|"src/test/resources/com/example/test/test-artifact-module-b"
argument_list|,
literal|"target/test-repository/com/example/test/test-artifact-module-b"
argument_list|)
expr_stmt|;
name|copyTestArtifactWithParent
argument_list|(
...
name|projectId
argument_list|(
literal|"test-artifact-module-b"
argument_list|)
operator|.
name|projectVersion
argument_list|(
...
name|path
init|=
literal|"test-snapshot-artifact/trunk/test-artifact-module-b"
decl_stmt|;
name|assertEquals
argument_list|(
name|TEST_SCM_CONN_BASE
