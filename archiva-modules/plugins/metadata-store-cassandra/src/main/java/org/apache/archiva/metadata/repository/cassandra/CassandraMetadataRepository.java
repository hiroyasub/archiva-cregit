...
return|;
block|}
comment|/**      * Implementation is not very performant, because sorting is part of the stream. I do not know how to specify the sort      * in the query.      *       * @param session      * @param repositoryId      * @param facetClazz      * @param offset      * @param maxEntries      * @param<T>      * @return      * @throws MetadataRepositoryException      */
annotation|@
name|Override
specifier|public
parameter_list|<
