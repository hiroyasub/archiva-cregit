...
comment|//metadataFacetModelEntityManager.visitAll( new Function<MetadataFacetModel, Boolean>()
specifier|final
name|List
argument_list|<
name|ProjectVersionMetadataModel
...
comment|//List<Namespace> namespaces = namespaceEntityManager.find( query );
specifier|final
name|Set
argument_list|<
name|Namespace
