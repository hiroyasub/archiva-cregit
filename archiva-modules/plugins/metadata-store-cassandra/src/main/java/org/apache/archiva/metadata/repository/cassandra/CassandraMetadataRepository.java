...
name|debug
argument_list|(
literal|"time to insert repository: {}"
argument_list|,
name|mutationResult
operator|.
name|getExecutionTimeMicro
argument_list|()
argument_list|)
expr_stmt|;
return|return
...
return|;
block|}
comment|/**      * Implementation is not very performant, because sorting is part of the stream. I do not know how to specify the sort      * in the query.      *       * @param<T>      * @param session      * @param repositoryId      * @param facetClazz      * @param queryParameter      * @return      * @throws MetadataRepositoryException      */
annotation|@
name|Override
specifier|public
parameter_list|<
...
argument_list|()
decl_stmt|;
comment|// TODO doing multiple queries, there should be a way to get all the artifactMetadatas for any number of
comment|// projects
for|for
control|(
name|Row
...
block|}
return|return
name|mapArtifactMetadataToArtifact
argument_list|(
name|metadataFacetResult
argument_list|,
name|artifactMetadatas
...
return|;
block|}
comment|/**      * Attach metadata to each of the  ArtifactMetadata objects      */
specifier|private
name|List
argument_list|<
name|ArtifactMetadata
