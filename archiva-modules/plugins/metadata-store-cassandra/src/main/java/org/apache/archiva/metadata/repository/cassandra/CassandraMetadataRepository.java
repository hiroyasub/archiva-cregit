...
argument_list|()
decl_stmt|;
comment|/*         ColumnFamilyResult<String, String> columnFamilyResult =             this.projectVersionMetadataModelTemplate.queryColumns( key, Arrays.asList( "id", "description", "name",                                                                                        "namespaceId", "repositoryName",                                                                                        "incomplete", "projectId",                                                                                        "url" ) );         if (!columnFamilyResult.hasResults())         {             return null;         }*/
if|if
condition|(
name|result
operator|.
