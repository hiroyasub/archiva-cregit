...
return|;
block|}
comment|/**      * Project version and artifact level metadata are stored in the same place, no distinctions in Cassandra      * implementation, just calls {@link #getArtifactsByMetadata(String, String, String)}      */
annotation|@
name|Override
specifier|public
name|List
