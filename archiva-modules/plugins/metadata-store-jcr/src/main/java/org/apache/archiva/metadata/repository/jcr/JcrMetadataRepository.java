...
name|versionNode
init|=
name|getOrCreateProjectVersionNode
argument_list|(
name|repositoryId
argument_list|,
name|namespace
...
name|repo
init|=
name|getOrCreateRepositoryContentNode
argument_list|(
name|repositoryId
argument_list|)
decl_stmt|;
...
name|node
init|=
name|getOrCreateRepositoryNode
argument_list|(
name|repositoryId
argument_list|)
decl_stmt|;
...
argument_list|)
decl_stmt|;
comment|// TODO: could we simply query all nodes with no children?
name|recurse
argument_list|(
name|facets
argument_list|,
...
parameter_list|)
block|{
comment|// TODO: handle this case differently?
