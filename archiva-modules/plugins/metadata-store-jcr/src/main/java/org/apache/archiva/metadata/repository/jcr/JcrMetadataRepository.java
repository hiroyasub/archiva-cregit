...
expr_stmt|;
block|}
comment|//        registerMixinNodeType( nodeTypeManager, REPOSITORY_NODE_TYPE );
comment|//        registerMixinNodeType( nodeTypeManager, NAMESPACE_NODE_TYPE );
comment|//        registerMixinNodeType( nodeTypeManager, PROJECT_NODE_TYPE );
comment|//        registerMixinNodeType( nodeTypeManager, PROJECT_VERSION_NODE_TYPE );
comment|//        registerMixinNodeType( nodeTypeManager, ARTIFACT_NODE_TYPE );
comment|//        registerMixinNodeType( nodeTypeManager, FACET_NODE_TYPE );
comment|//        registerMixinNodeType( nodeTypeManager, DEPENDENCY_NODE_TYPE );
block|}
specifier|private
specifier|static
name|void
