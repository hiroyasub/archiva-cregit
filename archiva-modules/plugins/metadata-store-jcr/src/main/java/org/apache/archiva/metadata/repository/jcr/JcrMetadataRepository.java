...
begin_comment
comment|/**  * @plexus.component role="org.apache.archiva.metadata.repository.MetadataRepository"  * @todo path construction should be centralised  * @todo review all methods for alternate implementations (use of queries)  * @todo below: exception handling  * @todo below: revise storage format for project version metadata  */
end_comment
...
specifier|final
name|String
name|ARTIFACT_FACET_NODE_TYPE
init|=
literal|"archiva:artifactFacet"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
expr_stmt|;
block|}
comment|// TODO: namespaced properties instead?
name|Node
name|facetNode
init|=
name|JcrUtils
...
control|)
block|{
comment|// TODO: shouldn't need to recreate, just update
if|if
condition|(
name|facetNode
operator|.
...
parameter_list|)
block|{
comment|// TODO: try weak reference?
comment|// TODO: is this tree the right way up? It differs from the content model
try|try
block|{
name|Node
name|node
...
argument_list|)
decl_stmt|;
comment|// TODO: could we simply query all nodes with no children? Or perhaps a specific nodetype?
comment|//   Might be better to review the purpose of this function - why is the list of paths helpful?
name|recurse
argument_list|(
name|facets
argument_list|,
...
argument_list|)
decl_stmt|;
comment|// TODO: exception if missing?
if|if
condition|(
name|root
operator|.
...
name|q
init|=
literal|"SELECT * FROM [archiva:artifact]"
decl_stmt|;
name|String
name|clause
init|=
...
argument_list|)
decl_stmt|;
comment|// TODO: use query by reference type
name|NodeIterator
name|i
init|=
name|node
...
parameter_list|)
block|{
comment|// TODO: could be simpler with pathed namespaces, rely on namespace property
name|Collection
argument_list|<
name|String
argument_list|>
...
comment|//        {
comment|//            // TODO: second arg should be a better URL for the namespace
