...
begin_comment
comment|/**  * File implementation of the metadata repository. It uses property files in a separate directory tree.  * The implementation has no fulltext index. So fulltext queries are not supported.  *  * Some retrieval methods may not be very efficient.  */
end_comment
...
name|error
argument_list|(
literal|"Could not update project {}, {}, {}: {}"
argument_list|,
name|repoId
argument_list|,
name|namespace
...
name|error
argument_list|(
literal|"Could not update project version {}, {}, {}: {}"
argument_list|,
name|repoId
argument_list|,
name|namespace
...
name|error
argument_list|(
literal|"Could not update project reference {}, {}, {}, {}: {}"
argument_list|,
name|repoId
argument_list|,
name|namespace
...
name|error
argument_list|(
literal|"Could not update namespace of {}, {}: {}"
argument_list|,
name|repoId
argument_list|,
name|namespace
...
name|error
argument_list|(
literal|"Could not retrieve facet metatadata {}, {}: {}"
argument_list|,
name|repositoryId
argument_list|,
name|facetId
...
name|error
argument_list|(
literal|"Could not read properties from {}, {}: {}"
argument_list|,
name|repositoryId
argument_list|,
name|facetId
...
block|}
block|}
comment|/**      * Result is sorted by date,      *      * @param session        The repository session      * @param repositoryId   The repository id      * @param startTime      The start time, can be<code>null</code>      * @param endTime        The end time, can be<code>null</code>      * @param queryParameter Additional parameters for the query that affect ordering and number of returned results.      * @return      * @throws MetadataRepositoryException      */
annotation|@
name|Override
specifier|public
name|Stream
...
block|}
block|}
comment|/**      * FIXME implements this !!!!      *      * @param session      * @param repositoryId      * @param namespace      * @param project      * @param projectVersion      * @param metadataFacet  will remove artifacts which have this {@link MetadataFacet} using equals      * @throws MetadataRepositoryException      */
annotation|@
name|Override
specifier|public
name|void
...
name|UnsupportedOperationException
argument_list|(
literal|"not yet implemented in File backend"
argument_list|)
throw|;
block|}
annotation|@
...
name|UnsupportedOperationException
argument_list|(
literal|"searchArtifacts not yet implemented in File backend"
argument_list|)
throw|;
block|}
annotation|@
