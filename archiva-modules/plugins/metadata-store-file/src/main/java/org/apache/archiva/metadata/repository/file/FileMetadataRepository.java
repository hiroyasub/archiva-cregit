...
block|}
block|}
comment|/**      * FIXME implements this !!!!      * @param repositoryId      * @param namespace      * @param project      * @param projectVersion      * @param projectId      * @param metadataFacet  will remove artifacts which have this {@link MetadataFacet} using equals      * @throws MetadataRepositoryException      */
specifier|public
name|void
name|removeArtifact
parameter_list|(
