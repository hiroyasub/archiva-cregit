...
block|{
comment|/**      * Update metadata for a particular project in the metadata repository, or create it if it does not already exist.      *      * @param session      * @param repositoryId the repository the project is in      * @param project      the project metadata to create or update      */
name|void
name|updateProject
parameter_list|(
...
name|MetadataRepositoryException
function_decl|;
comment|/**      * create the namespace in the repository. (if not exist)      *      *      * @param session      * @param repositoryId      * @param namespace      * @throws MetadataRepositoryException      */
name|void
...
name|MetadataRepositoryException
function_decl|;
comment|/**      *      * @param session      * @param repositoryId      * @param facetId      * @return true if the repository datas for this facetId      * @throws MetadataRepositoryException      * @since 1.4-M4      */
name|boolean
