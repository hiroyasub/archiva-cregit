...
name|MetadataRepositoryException
function_decl|;
comment|/**      * Get artifacts with a project version metadata key that matches the passed value.      *        * @param key      * @param value      * @param repositoryId can be null, meaning search in all repositories      * @return a list of artifacts      * @throws MetadataRepositoryException      */
name|List
argument_list|<
name|ArtifactMetadata
argument_list|>
...
name|MetadataRepositoryException
function_decl|;
comment|/**      * Get artifacts with an artifact metadata key that matches the passed value.      *        * @param key      * @param value      * @param repositoryId can be null, meaning search in all repositories      * @return a list of artifacts      * @throws MetadataRepositoryException      */
name|List
argument_list|<
name|ArtifactMetadata
argument_list|>
...
name|MetadataRepositoryException
function_decl|;
comment|/**      * Get artifacts with a property key that matches the passed value.      * Possible keys are 'scm.url', 'org.name', 'url', 'mailingList.0.name', 'license.0.name',...      *        * @param key      * @param value      * @param repositoryId can be null, meaning search in all repositories      * @return a list of artifacts      * @throws MetadataRepositoryException      */
name|List
argument_list|<
name|ArtifactMetadata
argument_list|>
...
name|MetadataRepositoryException
function_decl|;
comment|/**      * Full text artifacts search.      *        * @param text      * @param repositoryId can be null to search in all repositories      * @param exact running an exact search, the value must exactly match the text.        * @return a list of artifacts      * @throws MetadataRepositoryException      */
name|List
argument_list|<
name|ArtifactMetadata
argument_list|>
...
name|MetadataRepositoryException
function_decl|;
comment|/**      * Full text artifacts search inside the specified key.      *        * @param key search only inside this key      * @param text      * @param repositoryId can be null to search in all repositories      * @param exact running an exact search, the value must exactly match the text.        * @return a list of artifacts      * @throws MetadataRepositoryException      */
name|List
argument_list|<
name|ArtifactMetadata
argument_list|>
