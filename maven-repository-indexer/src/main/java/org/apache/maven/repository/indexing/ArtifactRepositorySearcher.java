...
parameter_list|()
block|{
comment|//PerFieldAnalyzerWrapper wrapper = new PerFieldAnalyzerWrapper(new SimpleAnalyzer());
comment|//wrapper.addAnalyzer(VERSION, new StandardAnalyzer());
comment|//return wrapper;
return|return
operator|new
