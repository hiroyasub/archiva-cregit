...
begin_comment
comment|/**  * This class is to be invoked or called by the action class for  * general and advanced searching. It uses the DefaultRepositoryIndexSearcher  * to perform the search and constructs the search result objects to be  * returned to tha webapp action class.  *  * @plexus.component role="org.apache.maven.repository.indexing.RepositoryIndexSearchLayer"  */
end_comment

begin_class
specifier|public
class|class
name|DefaultRepositoryIndexSearchLayer
