...
decl_stmt|;
comment|/**      * Class Constructor      *      * @param indexPath  the path to the index      * @param repository the repository where the metadata to be indexed is located      * @throws RepositoryIndexException      */
specifier|public
name|MetadataRepositoryIndex
parameter_list|(
name|String
