...
name|Exception
block|{
comment|//test when the object passed in the index(..) method is not a RepositoryMetadat instance
name|RepositoryIndexingFactory
name|factory
init|=
operator|(
...
argument_list|()
expr_stmt|;
comment|//test when the plugin prefix is blank
name|factory
operator|=
operator|(
name|RepositoryIndexingFactory
...
argument_list|()
expr_stmt|;
comment|//test when the index is closed
try|try
block|{
name|RepositoryMetadata
name|repoMetadata
...
name|fail
argument_list|(
literal|"Must throw exception when a metadata is added to the index while the indexer is still closed."
argument_list|)
expr_stmt|;
block|}
catch|catch
