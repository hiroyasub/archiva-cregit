...
specifier|public
class|class
name|PomRepositoryIndexingTest
extends|extends
name|PlexusTestCase
block|{
specifier|private
...
name|fail
argument_list|(
literal|"Must throw exception when the passed object is not of type model."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|/**      * Test delete of pom document from index.      *      * @throws Exception      */
specifier|public
name|void
name|testDeletePomDocument
parameter_list|()
throws|throws
name|Exception
block|{
