...
argument_list|)
decl_stmt|;
comment|// TODO: is this going to be problematic because repository is remote format, but being used as local?
comment|// TODO: should it try to use the repo manager as a remote repo, proxying out?
comment|// TODO: maybe we can decouple the assembly parts of the project builder from the repository handling
name|MavenProject
name|project
init|=
name|projectBuilder
...
name|addActionError
argument_list|(
literal|"The given artifact was not found in the repository"
argument_list|)
expr_stmt|;
return|return
name|ERROR
