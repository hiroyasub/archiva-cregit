...
begin_comment
comment|/**  * An index record type for the standard index.  *  * @author Edwin Punzalan  * @author Brett Porter  * @plexus.component role="org.apache.maven.archiva.indexing.record.RepositoryIndexRecordFactory" role-hint="standard"  */
end_comment
