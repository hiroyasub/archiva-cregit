...
name|get
argument_list|(
literal|"/commons-logging/jars/commons-logging-1.0.jar"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|get
argument_list|(
literal|"/commons-logging/jars/commons-logging-2.0.jar"
argument_list|)
expr_stmt|;
name|fail
argument_list|(
...
name|getRemoteFile
argument_list|(
literal|"/commons-logging/jars/commons-logging-1.0.jar.md5"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|getTestFile
argument_list|(
literal|"src/test/m1-remote-repo"
argument_list|)
decl_stmt|;
name|ProxyRepository
name|repo1
