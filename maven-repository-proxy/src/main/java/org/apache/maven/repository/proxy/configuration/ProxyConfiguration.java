...
begin_comment
comment|/**  * Class to represent the configuration file for the proxy  *  * @author Edwin Punzalan  */
end_comment
...
specifier|private
name|ArtifactRepositoryPolicy
name|cacheReleasePolicy
decl_stmt|;
specifier|private
name|ArtifactRepositoryPolicy
name|cacheSnapshotPolicy
decl_stmt|;
