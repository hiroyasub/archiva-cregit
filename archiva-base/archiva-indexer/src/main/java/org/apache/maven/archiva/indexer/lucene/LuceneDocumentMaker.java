...
begin_comment
comment|/**  * LuceneDocumentMaker - a utility class for making lucene documents.   *  * @author<a href="mailto:joakim@erdfelt.com">Joakim Erdfelt</a>  * @version $Id$  */
end_comment
...
name|IllegalArgumentException
argument_list|(
literal|"Not allowed to have a null primary key."
argument_list|)
throw|;
block|}
if|if
...
name|IllegalArgumentException
argument_list|(
literal|"Not allowed to have an empty primary key."
argument_list|)
throw|;
block|}
name|document
