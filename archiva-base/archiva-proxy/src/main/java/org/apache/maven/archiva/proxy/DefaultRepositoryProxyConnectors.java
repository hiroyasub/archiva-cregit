...
return|;
block|}
comment|/**      * Test if the provided ManagedRepositoryConfiguration has any proxies configured for it.      */
specifier|public
name|boolean
name|hasProxies
parameter_list|(
...
name|ProxyException
argument_list|(
literal|"Unable to proxy due to bad managed repository layout definition ["
operator|+
name|repository
operator|.
name|getId
argument_list|()
operator|+
literal|"] had a layout defined as ["
operator|+
name|repository
operator|.
name|getLayout
...
name|ProxyException
argument_list|(
literal|"Unable to proxy due to bad remote repository layout definition ["
operator|+
name|repository
operator|.
name|getId
