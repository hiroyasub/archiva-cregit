...
begin_comment
comment|/**  * M2 implementation for cleaning up the released snapshots.  *  * @author<a href="mailto:oching@apache.org">Maria Odea Ching</a>  * @version  */
end_comment
...
parameter_list|)
block|{
comment|// continue updating other metadata files even if there is an exception
comment|// @todo log to console
block|}
block|}
block|}
block|}
