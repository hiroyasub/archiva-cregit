...
begin_comment
comment|/**  * A component that is first in the plexus startup that ensure that the configuration  * file format has been upgraded properly.   *  * @author<a href="mailto:joakim@erdfelt.com">Joakim Erdfelt</a>  * @version $Id$  *   * @plexus.component role="org.apache.maven.archiva.configuration.ConfigurationUpgrade"  *                   role-hint="default"  */
end_comment
...
literal|1
decl_stmt|;
comment|/* NOTE: This component should *NOT USE* the configuration api to do it's upgrade */
specifier|public
name|void
name|initialize
parameter_list|()
