...
begin_comment
comment|/**  * A component that is first in the plexus startup that ensure that the configuration  * file format has been upgraded properly.   *  * @author<a href="mailto:joakim@erdfelt.com">Joakim Erdfelt</a>  * @version $Id$  */
end_comment
...
name|logger
decl_stmt|;
comment|/**      * Perform the upgrade (if needed).      *       * NOTE: This component should *NOT USE* the configuration api to do it's upgrade      *       * @return true if the upgrade modified the archiva.xml file. false otherwise.      */
specifier|public
name|boolean
name|perform
parameter_list|()
