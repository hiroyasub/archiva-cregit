...
argument_list|)
expr_stmt|;
comment|/* FIXME: can't get rid of old v1<repositories> section programatically.         String actualXML = FileUtils.fileRead( userFile );         XMLAssert.assertXpathNotExists( "//configuration/repositories/repository", actualXML );         XMLAssert.assertXpathNotExists( "//configuration/repositories", actualXML );          */
block|}
specifier|public
name|void
name|testArchivaV1
