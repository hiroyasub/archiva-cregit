...
begin_comment
comment|/**  * ProjectModelMerge  *  * @author<a href="mailto:joakim@erdfelt.com">Joakim Erdfelt</a>  * @version $Id$  */
end_comment
...
parameter_list|(
name|DependencyTree
name|mainDependencyTree
parameter_list|,
name|DependencyTree
name|parentDependencyTree
parameter_list|)
block|{
if|if
condition|(
...
parameter_list|(
name|List
name|mainDependencyEdges
parameter_list|,
name|List
name|parentDependencyEdges
parameter_list|)
block|{
if|if
condition|(
