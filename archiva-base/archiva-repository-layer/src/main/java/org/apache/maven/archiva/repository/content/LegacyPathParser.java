...
begin_comment
comment|/**  * LegacyPathParser is a parser for maven 1 (legacy layout) paths to ArtifactReference.   *  * @author<a href="mailto:joakime@apache.org">Joakim Erdfelt</a>  * @version $Id$  */
end_comment
