...
specifier|public
name|void
name|testGatherAvailableVersionsBadArtifact
parameter_list|()
throws|throws
name|Exception
block|{
name|assertAvailableVersions
argument_list|(
...
specifier|public
name|void
name|testGatherAvailableVersionsMissingMultipleVersions
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testGatherAvailableVersionsSimpleYetIncomplete
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testGatherAvailableVersionsSimpleYetMissing
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Assert Available Versions: length/size"
argument_list|,
name|expectedVersions
operator|.
name|length
...
expr_stmt|;
block|}
comment|// assertTrue( "Metadata is similar: " + detailedDiff, detailedDiff.similar() );
comment|// XMLAssert.assertXMLEqual( expectedMetadata, actualMetadata );
block|}
specifier|private
name|void
name|assertMetadataPath
