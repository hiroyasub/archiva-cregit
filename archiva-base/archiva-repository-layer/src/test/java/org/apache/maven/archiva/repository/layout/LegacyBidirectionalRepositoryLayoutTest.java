...
index|]
operator|+
literal|"/jars/maven-metadata.xml"
expr_stmt|;
case|case
literal|1
case|:
...
specifier|public
name|boolean
name|suitableForArtifactTests
init|=
literal|true
decl_stmt|;
specifier|public
name|boolean
name|suitableForVersionedTests
init|=
literal|false
decl_stmt|;
specifier|public
name|boolean
name|suitableForProjectTests
init|=
literal|false
decl_stmt|;
specifier|public
...
name|setDelimitedPath
argument_list|(
literal|"com.foo.lib|source.jars|foo-lib-2.1-alpha-1-sources.jar"
argument_list|)
expr_stmt|;
name|ret
operator|.
...
name|setDelimitedPath
argument_list|(
literal|"org.apache.maven.test|jars|get-metadata-snapshot-1.0-20050831.101112-1.jar"
argument_list|)
expr_stmt|;
name|ret
operator|.
...
name|setDelimitedPath
argument_list|(
literal|"commons-lang|source.jars|commons-lang-2.3-sources.jar"
argument_list|)
expr_stmt|;
name|ret
operator|.
...
comment|// TODO: Not sure how to represent a VersionedReference as a legacy path.
comment|// Project References (done here by setting version, classifier, and type to null)
comment|// TODO: Not sure how to represent a ProjectReference as a legacy path.
return|return
name|ret
return|;
block|}
