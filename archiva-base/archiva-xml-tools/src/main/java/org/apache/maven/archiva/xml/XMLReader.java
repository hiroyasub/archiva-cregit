...
begin_comment
comment|/**  * XMLReader - a set of common xml utility methods for reading content out of an xml file.   *  * @author<a href="mailto:joakim@erdfelt.com">Joakim Erdfelt</a>  * @version $Id$  */
end_comment
