...
begin_comment
comment|/**  * Implementation of repository conversion class.  *  * @author<a href="mailto:brett@apache.org">Brett Porter</a>  * @plexus.component role="org.apache.maven.archiva.converter.RepositoryConverter" role-hint="default"  */
end_comment
...
parameter_list|)
block|{
comment|// TODO: should we be able to identify/fix these?
comment|// TODO: write archiva-artifact-repair module
name|triggerConversionEvent
argument_list|(
operator|new
...
name|warn
argument_list|(
literal|"ConversionEvent resulted in exception from listener: "
operator|+
name|t
operator|.
name|getMessage
