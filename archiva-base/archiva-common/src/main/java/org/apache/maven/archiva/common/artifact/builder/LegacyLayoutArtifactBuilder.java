...
begin_comment
comment|/**  * LegacyLayoutArtifactBuilder   *  * @author<a href="mailto:joakime@apache.org">Joakim Erdfelt</a>  * @version $Id$  *   *  @plexus.component role="org.apache.maven.archiva.common.artifact.builder.LayoutArtifactBuilder"  *     role-hint="legacy"  */
end_comment
...
argument_list|(
literal|"Unable to build legacy artifact with a null artifactFactory."
argument_list|)
throw|;
block|}
name|StringTokenizer
