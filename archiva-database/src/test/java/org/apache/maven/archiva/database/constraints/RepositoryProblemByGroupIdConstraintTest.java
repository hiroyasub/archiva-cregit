...
begin_comment
comment|/**  * RepositoryProblemByGroupIdConstraintTest  */
end_comment

begin_class
specifier|public
class|class
name|RepositoryProblemByGroupIdConstraintTest
extends|extends
name|AbstractArchivaDatabaseTestCase
block|{
specifier|private
...
name|assertNotNull
argument_list|(
literal|"Repository Problems by Group Id: Not Null"
argument_list|,
name|results
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"Repository Problems by Group Id: Results.size"
argument_list|,
name|expectedHits
argument_list|,
name|results
