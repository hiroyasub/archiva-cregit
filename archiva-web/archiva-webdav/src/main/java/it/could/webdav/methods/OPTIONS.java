...
begin_comment
comment|/**  *<p><a href="http://www.rfc-editor.org/rfc/rfc2616.txt">HTTP</a>  *<code>OPTIONS</code> metohd implementation.</p>   *  * @author<a href="http://could.it/">Pier Fumagalli</a>  */
end_comment
...
name|DAVMethod
block|{
comment|/**      *<p>Create a new {@link OPTIONS} instance.</p>      */
specifier|public
name|OPTIONS
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**      *<p>Process the<code>OPTIONS</code> method.</p>      */
specifier|public
name|void
name|process
parameter_list|(
