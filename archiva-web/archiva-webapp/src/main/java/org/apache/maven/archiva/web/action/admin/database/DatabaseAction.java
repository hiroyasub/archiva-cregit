...
name|cron
decl_stmt|;
comment|/**      * List of {@link AdminDatabaseConsumer} objects for unprocessed artifacts.      */
specifier|private
name|List
...
name|info
argument_list|(
literal|"Total Available Unprocessed Consumers: "
operator|+
name|databaseConsumers
operator|.
...
name|info
argument_list|(
literal|"Total Available Cleanup Consumers: "
operator|+
name|databaseConsumers
operator|.
...
name|info
argument_list|(
literal|"updateUnprocesedConsumers()"
argument_list|)
expr_stmt|;
return|return
name|INPUT
...
name|info
argument_list|(
literal|"updateCleanupConsumers()"
argument_list|)
expr_stmt|;
return|return
name|INPUT
