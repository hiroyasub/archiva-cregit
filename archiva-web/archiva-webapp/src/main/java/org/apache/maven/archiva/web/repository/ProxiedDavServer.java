...
argument_list|)
expr_stmt|;
comment|// missingUrl.append( request.getRequest().getPathInfo() );
name|String
name|message
init|=
...
argument_list|()
decl_stmt|;
comment|// Cleanup bad requests from maven 1.
comment|// Often seen is a double slash.
comment|// example: http://hostname:8080/archiva/repository/internal//pmd/jars/pmd-3.0.jar
if|if
condition|(
name|resource
operator|.
