...
begin_comment
comment|/**  * ConfigureProxyConnectorAction  *  * @author<a href="mailto:joakime@apache.org">Joakim Erdfelt</a>  * @version $Id$  * @plexus.component role="com.opensymphony.xwork.Action" role-hint="configureProxyConnectorAction"  */
end_comment
...
name|addActionError
argument_list|(
literal|"Unable to delete proxy connector with blank id for its source."
argument_list|)
expr_stmt|;
return|return
name|SUCCESS
...
name|addActionError
argument_list|(
literal|"Unable to delete proxy connector with blank id for its target."
argument_list|)
expr_stmt|;
return|return
name|SUCCESS
...
name|addActionError
argument_list|(
literal|"Unable to remove proxy connector, proxy connector with source ["
operator|+
name|source
operator|+
literal|"] and target ["
...
name|addActionError
argument_list|(
literal|"Unable to add new proxy connector with source ["
operator|+
name|sourceId
operator|+
literal|"] and target ["
...
name|targetId
operator|+
literal|"] as previously declared proxy connector, go edit that one instead."
argument_list|)
expr_stmt|;
return|return
name|INPUT
