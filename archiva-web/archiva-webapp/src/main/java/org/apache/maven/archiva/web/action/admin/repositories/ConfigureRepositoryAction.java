...
parameter_list|()
block|{
comment|// Ensure a proper mode is set.
if|if
condition|(
name|StringUtils
operator|.
...
name|addActionError
argument_list|(
literal|"Unable to process save request. edit mode undefined. "
argument_list|)
expr_stmt|;
return|return
name|ERROR
...
name|addActionError
argument_list|(
literal|"Unable to process save request. edit mode is invalid."
argument_list|)
expr_stmt|;
return|return
name|ERROR
...
return|;
block|}
comment|// If we are in edit mode, then remove the old repository configuration.
if|if
condition|(
name|StringUtils
operator|.
...
expr_stmt|;
block|}
comment|// Validate the existance of the repository id, but not in edit mode.
if|else if
condition|(
operator|!
name|StringUtils
