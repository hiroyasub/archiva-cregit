...
begin_comment
comment|/**  * Test the repository converter.  *  * @author<a href="mailto:brett@apache.org">Brett Porter</a>  * @todo what about deletions from the source repository?  * @todo use artifact-test instead  * @todo should reject if dependencies are missing - rely on reporting?  */
end_comment
...
argument_list|)
expr_stmt|;
comment|// TODO: test warnings (separate test?)
block|}
specifier|private
specifier|static
name|void
...
name|assertEquals
argument_list|(
literal|"Check POM was converted"
argument_list|,
name|expectedContent
argument_list|,
name|targetContent
...
parameter_list|()
block|{
comment|// test snapshot artifact is converted
comment|// TODO
block|}
specifier|public
name|void
...
specifier|public
name|void
name|testCreateArtifactMetadata
parameter_list|()
block|{
comment|// test artifact level metadata is created when it doesn't exist on successful conversion
comment|// TODO
block|}
specifier|public
name|void
name|testCreateSnapshotMetadata
parameter_list|()
block|{
comment|// test snapshot metadata is created when it doesn't exist on successful conversion
comment|// TODO
block|}
specifier|public
name|void
...
specifier|public
name|void
name|testMergeSnapshotMetadata
parameter_list|()
block|{
comment|// test snapshot metadata is merged when it already exists on successful conversion
comment|// TODO
block|}
specifier|public
name|void
