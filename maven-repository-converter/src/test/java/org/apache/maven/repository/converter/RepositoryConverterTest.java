...
specifier|public
name|void
name|testSourceArtifactMetadataMerging
parameter_list|()
throws|throws
name|Exception
block|{
comment|// test metadata in target repository is merged with the metadata in the source repository
name|createModernSourceRepository
argument_list|()
expr_stmt|;
name|Artifact
...
literal|"test"
argument_list|,
literal|"correctArtifactMetadata"
argument_list|,
literal|"1.0.0"
argument_list|)
decl_stmt|;
...
name|getTestFile
argument_list|(
literal|"src/test/expected-files/v4artifact-source-merging-metadata.xml"
argument_list|)
decl_stmt|;
name|compareFiles
argument_list|(
