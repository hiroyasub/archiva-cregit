...
expr_stmt|;
block|}
comment|/**      * Create a checksum from the specified metadata file.      *      * @throws FileNotFoundException      * @throws NoSuchAlgorithmException      * @throws IOException      */
specifier|private
name|byte
index|[]
name|createChecksum
...
name|IOException
block|{
comment|// TODO: share with ArtifactRepositoryIndex.getChecksum(), ChecksumArtifactReporter.getChecksum()
name|InputStream
name|fis
init|=
operator|new
