...
argument_list|)
expr_stmt|;
comment|//System.out.println( "1 - SUCCESS ---> " + reporter.getSuccesses() );
block|}
catch|catch
parameter_list|(
name|Exception
...
argument_list|)
expr_stmt|;
comment|//System.out.println( "2 - FAILURES ---> " + reporter.getFailures() );
block|}
catch|catch
parameter_list|(
name|Exception
...
argument_list|()
decl_stmt|;
comment|//System.out.println( "3 - META SUCCESS ---> " + iter.hasNext() );
name|assertTrue
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//System.out.println("reporter.getFailures() ---> " + reporter.getFailures());
name|Iterator
name|iter
init|=
name|reporter
...
argument_list|()
decl_stmt|;
comment|//System.out.println( "4 - META FAILURE ---> " + iter.hasNext() );
name|assertTrue
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//System.out.println( "5 - ART FAILURE ---> " + reporter.getFailures() );
name|assertTrue
argument_list|(
name|reporter
operator|.
...
argument_list|()
decl_stmt|;
comment|//System.out.println( "5 - META FAILURE ---> " + iter.hasNext() );
name|assertTrue
argument_list|(
literal|"check if there is a failure"
argument_list|,
