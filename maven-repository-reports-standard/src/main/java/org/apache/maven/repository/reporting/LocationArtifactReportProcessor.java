...
block|}
block|}
comment|/**      * Validate the if the artifact exists in the specified location.      *      * @param filename      * @return      */
specifier|private
name|boolean
name|validateArtifactLocation
parameter_list|(
...
return|;
block|}
comment|/**      * Extract the contents of the artifact/jar file.      *      * @param filename      * @param groupId      * @param artifactId      * @param version      */
specifier|private
name|Model
name|unpackArtifact
parameter_list|(
...
try|try
block|{
comment|//Create the output file (clobbering the file if it exists).
name|FileOutputStream
name|file
init|=
operator|new
