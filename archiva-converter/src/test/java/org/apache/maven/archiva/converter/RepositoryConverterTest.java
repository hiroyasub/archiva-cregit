...
name|assertNotNull
argument_list|(
literal|"Should have error messages."
argument_list|)
expr_stmt|;
name|boolean
name|found
...
name|fail
argument_list|(
literal|"Check Results Counts expected:<"
operator|+
name|failures
operator|+
literal|","
...
expr_stmt|;
block|}
comment|// Attempt to find the message ...
for|for
control|(
name|Iterator
name|it
